...
final class LockInfo
{
    ...
    LockInfo(final Label leadingLabel, final Expression lockAcquire) {
        this(leadingLabel, null, null, null, lockAcquire);
    }
    
    LockInfo(final Label leadingLabel, final Expression lockInit, final Expression lockStore, final Expression lockStoreCopy, final Expression lockAcquire) {
        super();
        ...
        this.operationCount = ((leadingLabel != null) ? 1 : 0) + ((lockStore != null) ? 1 : 0) + ((lockStoreCopy != null) ? 1 : 0) + (true ? 1 : 0);
    }
}
