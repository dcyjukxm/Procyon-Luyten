...
public class JavaFormattingOptions
{
    ...
    public JavaFormattingOptions() {
        super();
        this.AnonymousClassBraceStyle = BraceStyle.DoNotChange;
        this.ClassBraceStyle = BraceStyle.DoNotChange;
        this.InterfaceBraceStyle = BraceStyle.DoNotChange;
        this.AnnotationBraceStyle = BraceStyle.DoNotChange;
        this.EnumBraceStyle = BraceStyle.DoNotChange;
        this.MethodBraceStyle = BraceStyle.DoNotChange;
        this.InitializerBlockBraceStyle = BraceStyle.DoNotChange;
        this.ConstructorBraceStyle = BraceStyle.DoNotChange;
        this.EventBraceStyle = BraceStyle.DoNotChange;
        this.EventAddBraceStyle = BraceStyle.DoNotChange;
        this.EventRemoveBraceStyle = BraceStyle.DoNotChange;
        this.StatementBraceStyle = BraceStyle.DoNotChange;
        this.IfElseBraceEnforcement = BraceEnforcement.DoNotChange;
        this.ForBraceEnforcement = BraceEnforcement.DoNotChange;
        this.ForEachBraceEnforcement = BraceEnforcement.DoNotChange;
        this.WhileBraceEnforcement = BraceEnforcement.DoNotChange;
        this.UsingBraceEnforcement = BraceEnforcement.DoNotChange;
        this.FixedBraceEnforcement = BraceEnforcement.DoNotChange;
        this.ArrayInitializerWrapping = Wrapping.DoNotWrap;
        this.ArrayInitializerBraceStyle = BraceStyle.DoNotChange;
    }
