...
public final class VariableDefinitionCollection extends Collection<VariableDefinition>
{
    ...
    public int slotCount() {
        ...
        for (int i = 0; i < this.size(); ++i) {
            final VariableDefinition v = this.get(i);
    ...
    public VariableDefinition tryFind(final int slot, final int instructionOffset) {
        ...
        for (int i = 0; i < this.size(); ++i) {
            final VariableDefinition variable = this.get(i);
    ...
    public VariableDefinition find(final int slot, final int instructionOffset) {
        final VariableDefinition variable = this.tryFind(slot, instructionOffset);
        if (variable != null) {
            return variable;
        }
    ...
    public VariableReference reference(final int slot, final OpCode op, final int instructionOffset) {
        final VariableReference variable = this.tryFind(slot, op, instructionOffset);
        if (variable != null) {
            return variable;
        }
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$com$strobel$assembler$ir$OpCode() {
        final int[] loc_0 = VariableDefinitionCollection.$SWITCH_TABLE$com$strobel$assembler$ir$OpCode;
        if (loc_0 != null) {
            return loc_0;
        }
        ...
        return VariableDefinitionCollection.$SWITCH_TABLE$com$strobel$assembler$ir$OpCode = loc_1;
    }
