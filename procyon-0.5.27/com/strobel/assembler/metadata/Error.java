...
final class Error
{
    ...
    public static RuntimeException invalidSignatureUnresolvedTypeVariable(final String signature, final String variableName, final int position) {
        return new IllegalArgumentException(String.format("Invalid signature: unresolved type variable '%s' at position %d.  (%s)", variableName, position, signature));
    }
